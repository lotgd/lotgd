...
class SceneFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $scenes = [
            ...
            "weapons" => (new Scene())
                ...
                ->setDescription("MightyE stands behind a table and doesn't seemingly care when you enter the shop. 
                    ...
                    Finally, MightE nods at you, stroking his goatee and whishing for an excuse to use one of his weapons.")
        ];
        ...
        $villageToWeaponsConnection = $scenes["village"]->connectTo($scenes["weapons"], sourceLabel: "MightyEs weapons", targetLabel: "Back to the village");
